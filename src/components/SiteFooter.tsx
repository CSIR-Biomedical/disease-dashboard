      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2">
          <Link to="/" className="flex items-center gap-3 mb-6 w-fit">
            ...
            />
            <span className="font-['Merriweather',serif] font-bold text-xl text-white">
              CSIR CHRI
            </span>
          </Link>
          <p className="text-sm leading-relaxed max-w-sm">
            The CSIR Center for Health Research and Innovation is a premier scientific institution
            committed to safeguarding public health through rigorous, data-driven research and
            epidemiological excellence.
          </p>
        </div>
